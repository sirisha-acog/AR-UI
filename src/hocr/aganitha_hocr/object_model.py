...
class Region(object):
    ...
    def __init__(self, file: HTMLParsingUtils, x_top_left: int, y_top_left: int, x_bot_right: int, y_bot_right: int):
        self.file = file
...
class Block(object):
    ...
    def __init__(self, x_top_left: float, y_top_left: float, x_bot_right: float, y_bot_right: float, word: str):
        self.x_top_left = x_top_left
        self.y_top_left = y_top_left
        self.x_bot_right = x_bot_right
        self.y_bot_right = y_bot_right
